...
app.layout = html.Div(children=[html.H1('SpaceX Launch Records Dashboard',
                                ...
                                #dcc.RangeSlider(min=0, max=10000, step=1000,marks={0: '0',100: '100'},value=[0, 100],id='id-range-slider'),
                                dcc.RangeSlider(id='payload-slider',min=0, max=spacex_df['Payload Mass (kg)'].max(), step=1000,value=[0, spacex_df['Payload Mass (kg)'].max()]),
...
def get_pie_chart(entered_site):
    ...
    if entered_site == 'ALL':
        ...
        names='class',
        title='Total success by site: ' + entered_site)
        return fig
...
def get_scatter_chart(payload,entered_site):
    filtered_df = spacex_df.loc[spacex_df['Payload Mass (kg)']<payload[1]]
    if entered_site == 'ALL':
